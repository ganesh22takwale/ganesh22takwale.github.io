if (sessionStorage.getItem("grt_used")) {
  document.body.innerHTML =
    "<div style='padding:80px;font-family:Inter'><h2>Session Completed</h2><p>This simulation runs once per visit.</p></div>";
...
function update(){
  ...
  if(m>7 && mo<4){riskScore+=18; log("Latent failure from unmonitored memory.");}
  if(a<4){riskScore+=12; log("Alignment weakness reduced trust.");}
